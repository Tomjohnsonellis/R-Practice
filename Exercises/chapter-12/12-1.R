...
## ggplot2 was not found depsite tidyverse being installed, this fixed it
install.packages(
  "ggplot2",
...
setwd("~/GitHub/R-Practice/Exercises/chapter-12")
...
## Nice to make a few graphs, gather() and spread() are both new to me