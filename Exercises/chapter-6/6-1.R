...
# This may be overkill but I could not find a way to print the actual variable name
variable_names <- c("round_sum", "sum_round")
variable_names[which.max(c(round_1, round_2))]
